...
/**
 * @param {flatbuffers.Builder} builder
 * @param {SailorIO.Models.SupplyTypes} supplyId
 */
SailorIO.Models.Supply.addSupplyId = function(builder, supplyId) {
  builder.addFieldInt8(1, supplyId, SailorIO.Models.SupplyTypes.CRATE1);
};
 ...
 * @returns {SailorIO.Models.Supply}
 */
SailorIO.Models.WorldInfoTable.prototype.currentSupplies = function(index, obj) {
  var offset = this.bb.__offset(this.bb_pos, 16);
 ...
 * @returns {number}
 */
SailorIO.Models.WorldInfoTable.prototype.currentSuppliesLength = function() {
  var offset = this.bb.__offset(this.bb_pos, 16);
 ...
 */
SailorIO.Models.WorldInfoTable.addCurrentSupplies = function(builder, currentSuppliesOffset) {
 ...
 * @returns {flatbuffers.Offset}
 */
SailorIO.Models.WorldInfoTable.createCurrentSuppliesVector = function(builder, data) {
 ...
 */
SailorIO.Models.WorldInfoTable.startCurrentSuppliesVector = function(builder, numElems) {
